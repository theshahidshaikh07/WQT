          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10 p-8 flex-1 flex flex-col">
                ...
                <button className="w-full flex items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-semibold transition-all duration-300 hover:scale-[1.02] hover:shadow-lg group/btn btn-card">
